...
@SourceType(value = "AvroARP", label = "Avro",uiConfig = "avro-layout.json")
public class AvroConf extends AbstractArpConf<AvroConf> {
  private static final String ARP_FILENAME = "arp/implementation/avro-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.avro.AvroDriver";
